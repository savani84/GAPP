			...
			<div class="col-md-12">
				<table width="100%">
					...
					<c:forEach items="${degrees}" var="degree" varStatus="status">
						<tr>
							<td>
								<form action="editOldAcademic.html" method="POST" enctype="multipart/form-data">
								<table width="100%" style="border:1px solid #2e6da4;">
									<tr>
										...
										<td>
											...
											<a href="removeAcademic.html?degreeid=${degree.id}&applicationid=${param.applicationid}"><input style="float:right;" type="button" class="btn btn-primary" value="Remove Academic" /></a>
										</td>
									</tr>
									<tr>
										<td width="13%">
										...
										<td colspan="2">
											<table width="100%">
												<tr>
													...
													<td>
														<input style="float:right;" type="submit" class="btn btn-primary" value="Update Academic" />
													</td>
												</tr>
											</table>
										</td>
						...
						<td>
							...
							<table width="100%" style="border:1px solid #2e6da4;">
								...
								<tr>
									...
									<td width="35%">
										<form:input path="major" class="form-control" placeholder="Enter the Major"/>
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<form:input path="gpa" class="form-control" placeholder="Enter the GPA"/>
									</td>
									<td></td>
									<td>
										<label for="targetGroup">Time Period<br/>(# year(s))</label>
									</td>
									<td>
										<form:input path="timePeriod" class="form-control" placeholder="Enter the Time Period"/>
									</td>
								</tr>
								<tr>
									<td>
					...
					<tr>
						<td>
							<a href="editOtherRequiremt.html?applicationid=${param.applicationid}"><input style="float:right;" type="button" class="btn btn-primary" value="Next >>" /></a>
						</td>
					</tr>
				</table>
			</div>
